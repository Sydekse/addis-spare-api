...
import { CurrencySettings, DeliveryZone, NotificationSettings } from "../entities/setting-data-types";
...
export interface SettingsRepository {
    ...
    updateCurrencySettings(id : string, currencySettings: CurrencySettings): Promise<void>;
    updateNotificationSettings(id : string, notificationSettings: NotificationSettings): Promise<void>;
}
